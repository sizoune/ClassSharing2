...
import com.studio.pattimura.testingclasssharing2.Fragment.BerandaFragment;
...
public class LandingPage extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        judul = (TextView) toolbar.findViewById(R.id.toolbarTitle);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.beranda) {
            ...
            startActivity(new Intent(LandingPage.this, HalamanBiodata.class));
        }
